...
const MidBanner = () => {
  return (
    <div className='bg-gray-100 md:py-24'>
      <div className='relative max-w-7xl mx-auto md:rounded-2xl pt-28 bg-cover bg-center h-[550px] md:h-[600px] ' style={{backgroundImage: `url(https://i.pinimg.com/1200x/cf/09/21/cf09211107f36eebff1822c5c375762d.jpg)`, backgroundPosition:'center', backgroundAttachment: 'fixed'}}>
