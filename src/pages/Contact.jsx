...
const Contact = () => {
    return (
        <div className="min-h-screen bg-gradient-to-r from-[#0f0c29] via-[#302b63] to-[#24243e]  items-center justify-center px-4 py-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="text-white space-y-6">
                        ...
                        <div>
                            ...
                            <p><strong>📧 Email:</strong> support@Fastro.com</p>
